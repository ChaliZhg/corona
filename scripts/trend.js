...
d3.json('https://gist.githubusercontent.com/ChaliZhg/afff054c4e46e1ae1caf62a3e59e6df4/raw/f6767a4dc6ddb37bce0636af0fcf79060a7e0739/csvjson.json', function (error, rawData) {
  if (error) {
    console.error(error);
    return;
  }
  ...
  d3.json('https://gist.githubusercontent.com/ChaliZhg/cbe5644eb8ac66e5608b46a2f9136583/raw/a57c61e580577c842df7892fb8c4befca8af0f0c/markers.json', function (error, markerData) {
    if (error) {
      console.error(error);
      return;
    }
